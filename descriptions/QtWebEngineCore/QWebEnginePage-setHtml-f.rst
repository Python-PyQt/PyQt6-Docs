.. sip:method-description::
    :status: todo
    :pysig: cd0abd9bf229aea5571e40602db296b2
...
**Warning:** The content will be percent encoded before being sent to the renderer. This may increase its size. The maximum size of the percent encoded content is 2 megabytes minus 30 bytes.
