.. sip:method-description::
    ...
    :digest: e564a6e5f7da3392b6c7028522026b63
...
The returned action does not have a default styled icon. Use :sip:ref:`~PyQt6.QtWebEngineWidgets.QWebEngineView.pageAction` to have an action with a default styled icon.
