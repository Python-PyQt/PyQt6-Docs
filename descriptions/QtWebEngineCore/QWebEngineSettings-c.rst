...
:sip:ref:`~PyQt6.QtWebEngineCore.QWebEngineSettings` allows configuration of browser properties, such as font sizes and families, the location of a custom style sheet, and generic attributes, such as JavaScript support. Individual attributes are set using the :sip:ref:`~PyQt6.QtWebEngineCore.QWebEngineSettings.setAttribute` function. The :sip:ref:`~PyQt6.QtWebEngineCore.QWebEngineSettings.WebAttribute` enum further describes each attribute.
