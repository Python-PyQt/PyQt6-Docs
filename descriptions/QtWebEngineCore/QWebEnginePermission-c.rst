.. sip:class-description::
    ...
    :digest: cea4dc828dd7b1cb74cb8de2603260e7
...
Alternatively, an application interested in modifying already granted permissions may use QWebEngineProfile::listAllPermissions() to get a list of existing permissions associated with a profile, or QWebEngineProfile::queryPermission() to get a :sip:ref:`~PyQt6.QtWebEngineCore.QWebEnginePermission` object for a specific permission.
...
.. seealso:: QWebEnginePage::permissionRequested()QWebEngineProfile::queryPermission()QWebEngineProfile::listAllPermissions().
