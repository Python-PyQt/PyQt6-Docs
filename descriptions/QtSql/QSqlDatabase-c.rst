...
The :sip:ref:`~PyQt6.QtSql.QSqlDatabase` class provides an interface for accessing a database through a connection. An instance of :sip:ref:`~PyQt6.QtSql.QSqlDatabase` represents the connection. The connection provides access to the database via one of the `supported database drivers <https://doc.qt.io/qt-6/sql-driver.html#supported-databases>`_, which are derived from :sip:ref:`~PyQt6.QtSql.QSqlDriver`. Alternatively, you can subclass your own database driver from :sip:ref:`~PyQt6.QtSql.QSqlDriver`. See `How to Write Your Own Database Driver <https://doc.qt.io/qt-6/sql-driver.html#how-to-write-your-own-database-driver>`_ for more information.
