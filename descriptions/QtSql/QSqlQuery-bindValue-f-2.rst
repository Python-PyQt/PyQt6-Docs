.. sip:method-description::
    :status: todo
    :pysig: 0928179e4272a14f2bfb8716a9f9f53e
...
To bind a NULL value, use a null :sip:ref:`~PyQt6.QtCore.QVariant`; for example, use ``QVariant(QMetaType::QString)`` if you are binding a string.
