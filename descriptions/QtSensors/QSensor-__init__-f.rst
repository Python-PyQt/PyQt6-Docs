.. sip:method-description::
    ...
    :digest: ce682148445c2e267995b0a690c2d564
...
Only use this constructor if there is no derived sensor class available. Note that all built-in sensors have a derived class, so using this constructor should only be necessary when implementing custom sensors, like in the `Grue sensor example <https://doc.qt.io/qt-6/qtsensors-grue-example.html>`_.
