.. sip:class-description::
    ...
    :digest: 497eb17e062d7ffdfc0a73142aa521f9

The :sip:ref:`~PyQt6.Qt3DExtras.QDiffuseSpecularMapMaterial` provides a default implementation of the phong lighting effect where the diffuse and specular light components are read from texture maps.
