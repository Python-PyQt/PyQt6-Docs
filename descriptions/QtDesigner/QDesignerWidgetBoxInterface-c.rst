...
*Qt Designer* uses an XML file to populate its widget box. The name of that file is one of the widget box's properties, and you can retrieve it using the :sip:ref:`~PyQt6.QtDesigner.QDesignerWidgetBoxInterface.fileName` function.
