.. sip:class-description::
    :status: todo
    :brief: Allows you to manipulate the collection of form windows in Qt Widgets Designer, and control Qt Widgets Designer's form editing actions
    :digest: 2e20ce42fd7a11c725d6a3f5ab575379

The :sip:ref:`~PyQt6.QtDesigner.QDesignerFormWindowManagerInterface` class allows you to manipulate the collection of form windows in Qt Widgets Designer, and control Qt Widgets Designer's form editing actions.

:sip:ref:`~PyQt6.QtDesigner.QDesignerFormWindowManagerInterface` is not intended to be instantiated directly. Qt Widgets Designer uses the form window manager to control the various form windows in its workspace. You can retrieve an interface to Qt Widgets Designer's form window manager using the :sip:ref:`~PyQt6.QtDesigner.QDesignerFormEditorInterface.formWindowManager` function. For example:
