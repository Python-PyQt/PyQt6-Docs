.. sip:class-description::
    ...
    :digest: d0b43e10d2c47a0c7d2e488da59e63be

The :sip:ref:`~PyQt6.QtGraphs.QSurface3DSeries` class represents a data series in a 3D surface graph.
...
The object mesh set via the :sip:ref:`~PyQt6.QtGraphs.QAbstract3DSeries.mesh` property defines the selection pointer shape in a surface series.

:sip:ref:`~PyQt6.QtGraphs.QSurface3DSeries` supports the following format tags for :sip:ref:`~PyQt6.QtGraphs.QAbstract3DSeries.setItemLabelFormat`:
