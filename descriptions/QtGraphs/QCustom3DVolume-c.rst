.. sip:class-description::
    ...
    :digest: 573aa5c55f49997b6c20aff8dea79fe9
...
**Note:** Only two formats are supported: :sip:ref:`~PyQt6.QtGui.QImage.Format.Format_Indexed8` and :sip:ref:`~PyQt6.QtGui.QImage.Format.Format_ARGB32`. If an indexed format is specified, :sip:ref:`~PyQt6.QtGraphs.QCustom3DVolume.colorTable` must also be set. Defaults to :sip:ref:`~PyQt6.QtGui.QImage.Format.Format_ARGB32`.
