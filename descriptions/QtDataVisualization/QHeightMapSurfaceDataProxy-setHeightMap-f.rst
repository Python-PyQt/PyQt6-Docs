...
The height map is resolved asynchronously. :sip:ref:`~PyQt6.QtDataVisualization.QSurfaceDataProxy.arrayReset` is emitted when the data has been resolved.

.. seealso:: :sip:ref:`~PyQt6.QtDataVisualization.QHeightMapSurfaceDataProxy.heightMap`.
