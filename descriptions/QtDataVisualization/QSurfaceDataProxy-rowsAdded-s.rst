...
This signal is emitted when the number of rows specified by *count* is added starting at the position *startIndex*. If rows are added to the array without calling :sip:ref:`~PyQt6.QtDataVisualization.QSurfaceDataProxy.addRow` or :sip:ref:`~PyQt6.QtDataVisualization.QSurfaceDataProxy.addRows`, this signal needs to be emitted to update the graph.
