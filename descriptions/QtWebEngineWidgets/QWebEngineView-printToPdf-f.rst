.. sip:method-description::
    :status: todo
    :pysig: 6b40acc2ae8b9e579c8458b8831d962a
...
This method issues an asynchronous request for printing the web page into a PDF and returns immediately. To be informed about the result of the request, connect to the signal :sip:ref:`~PyQt6.QtWebEngineWidgets.QWebEngineView.pdfPrintingFinished`.

If a file already exists at the provided file path, it will be overwritten.

.. seealso:: :sip:ref:`~PyQt6.QtWebEngineWidgets.QWebEngineView.pdfPrintingFinished`.
