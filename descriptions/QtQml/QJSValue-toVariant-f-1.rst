.. sip:method-description::
    ...
    :digest: e6dc5377270acb64096150ac1f505566
...
+------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------+
| QVariantMap Object                                               | A :sip:ref:`~PyQt6.QtCore.QVariant` containing the QVariantMap stored in the object (no conversion).               |
+------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------+
| QVariantHash Object                                              | A :sip:ref:`~PyQt6.QtCore.QVariant` containing the QVariantHash stored in the object (no conversion).              |
+------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------+
