.. sip:class-description::
    ...
    :digest: 0c173eb4d4d267a55468b1032e76589e
...
QML list properties are type-safe. Only :sip:ref:`~PyQt6.QtCore.QObject`'s that derive from the correct base class can be assigned to the list. The  method can be used to query the :sip:ref:`~PyQt6.QtCore.QMetaObject` of the :sip:ref:`~PyQt6.QtCore.QObject` type supported. Attempting to add objects of the incorrect type to a list property will fail.
