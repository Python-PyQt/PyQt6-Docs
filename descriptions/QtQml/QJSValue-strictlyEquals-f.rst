.. sip:method-description::
    ...
    :digest: 749b27453449719a2552dd5b0f079b6e

Returns true if this :sip:ref:`~PyQt6.QtQml.QJSValue` is equal to *other* using strict comparison (no conversion), otherwise returns false. The comparison follows the behavior described in `ECMA-262 <https://doc.qt.io/qt-6/http://www.ecma-international.org/publications/standards/Ecma-262.htm>`_ section 11.9.6, "The Strict Equality Comparison Algorithm".
