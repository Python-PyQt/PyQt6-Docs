.. sip:method-description::
    ...
    :realsig: ()
    :digest: b3183cbaad686cdc1755eac9fb965eb8

Grabs the contents of the window and returns it as an image.

It is possible to call the  function when the window is not visible. This requires that the window is :sip:ref:`~PyQt6.QtGui.QWindow.create` and has a valid size and that no other :sip:ref:`~PyQt6.QtQuick.QQuickWindow` instances are rendering in the same process.
