.. sip:method-description::
    ...
    :realsig: () const
    :digest: 9f6a981631d32d439b0ece7464e783a5
...
* :sip:ref:`~PyQt6.QtQuick.QSGRenderNode.StateFlags.DepthState` - depth write mask, depth test enabled, depth comparison function

* :sip:ref:`~PyQt6.QtQuick.QSGRenderNode.StateFlags.StencilState` - stencil write masks, stencil test enabled, stencil operations, stencil comparison functions

* :sip:ref:`~PyQt6.QtQuick.QSGRenderNode.StateFlags.ScissorState` - scissor enabled, scissor test enabled

* :sip:ref:`~PyQt6.QtQuick.QSGRenderNode.StateFlags.ColorState` - clear color, color write mask

* :sip:ref:`~PyQt6.QtQuick.QSGRenderNode.StateFlags.BlendState` - blend enabled, blend function

* :sip:ref:`~PyQt6.QtQuick.QSGRenderNode.StateFlags.CullState` - front face, cull face enabled

* :sip:ref:`~PyQt6.QtQuick.QSGRenderNode.StateFlags.ViewportState` - viewport

* :sip:ref:`~PyQt6.QtQuick.QSGRenderNode.StateFlags.RenderTargetState` - render target
