...
When *options* contains :sip:ref:`~PyQt6.QtQuick.QQuickWindow.CreateTextureOption.TextureCanUseAtlas`, the engine may put the image into a texture atlas. Textures in an atlas need to rely on :sip:ref:`~PyQt6.QtQuick.QSGTexture.normalizedTextureSubRect` for their geometry and will not support :sip:ref:`~PyQt6.QtQuick.QSGTexture.WrapMode.Repeat`. Other values from :sip:ref:`~PyQt6.QtQuick.QQuickWindow.CreateTextureOption.CreateTextureOption` are ignored.
