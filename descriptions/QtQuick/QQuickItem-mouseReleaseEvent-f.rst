.. sip:method-description::
    ...
    :realsig: (QMouseEvent*)
    :digest: c830384104e8743af57faa8fca403d27
...
In order to receive mouse release events, the preceding mouse press event must be accepted (by overriding :sip:ref:`~PyQt6.QtQuick.QQuickItem.mousePressEvent`, for example) and :sip:ref:`~PyQt6.QtQuick.QQuickItem.acceptedMouseButtons` must return the relevant mouse button.
