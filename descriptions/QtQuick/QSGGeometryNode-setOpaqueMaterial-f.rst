.. sip:method-description::
    ...
    :realsig: (QSGMaterial*)
    :digest: 007b4f723bc924921ebaf3b04f5cf3d5
...
The opaqueness refers to scene graph opacity, the material is still allowed to set :sip:ref:`~PyQt6.QtQuick.QSGMaterial.Flag.Blending` to true and draw transparent pixels.

If the material is changed without calling setOpaqueMaterial() again, the user must also mark the opaque material as dirty using :sip:ref:`~PyQt6.QtQuick.QSGNode.markDirty`.
