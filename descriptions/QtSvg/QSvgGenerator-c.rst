.. sip:class-description::
    ...
    :digest: c404703adc947598dc3c1214a5882802
...
The `SVG Generator Example <https://doc.qt.io/qt-6/qtsvg-svggenerator-example.html>`_ shows how the same painting commands can be used for painting a widget and writing an SVG file.
