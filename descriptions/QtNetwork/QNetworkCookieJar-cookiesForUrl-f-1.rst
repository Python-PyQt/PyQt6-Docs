.. sip:method-description::
    :status: todo
    :pysig: 4dbcf242c8a30735d7d0206b8376d763
...
The default :sip:ref:`~PyQt6.QtNetwork.QNetworkCookieJar` class implements only a very basic security policy (it makes sure that the cookies' domain and path match the reply's). To enhance the security policy with your own algorithms, override cookiesForUrl().
