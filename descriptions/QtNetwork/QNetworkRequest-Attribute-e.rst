.. sip:enum-description::
    :status: todo
    :digest: 2c501e3f3a4ee037efa6cc2e9b279bd5
...
The following table explains what the default attribute codes are, the :sip:ref:`~PyQt6.QtCore.QVariant` types associated, the default value if said attribute is missing and whether it's used in requests or replies.
