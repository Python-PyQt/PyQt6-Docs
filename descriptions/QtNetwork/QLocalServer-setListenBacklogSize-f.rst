...
**Note:** This property must be set prior to calling :sip:ref:`~PyQt6.QtNetwork.QLocalServer.listen`.

.. seealso:: :sip:ref:`~PyQt6.QtNetwork.QLocalServer.listenBacklogSize`.
