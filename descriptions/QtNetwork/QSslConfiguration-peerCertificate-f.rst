...
If you want to check the peer's complete chain of certificates, use :sip:ref:`~PyQt6.QtNetwork.QSslConfiguration.peerCertificateChain` to get them all at once.

.. seealso:: :sip:ref:`~PyQt6.QtNetwork.QSslConfiguration.peerCertificateChain`, :sip:ref:`~PyQt6.QtNetwork.QSslSocket.sslErrors`, :sip:ref:`~PyQt6.QtNetwork.QSslSocket.ignoreSslErrors`, :sip:ref:`~PyQt6.QtNetwork.QNetworkReply.sslErrors`, :sip:ref:`~PyQt6.QtNetwork.QNetworkReply.ignoreSslErrors`.
