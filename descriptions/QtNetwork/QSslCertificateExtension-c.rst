...
+-------------+------------------------------------------------------------------------------------------------------------------------------+
| value       | A `QVariant <https://doc.qt.io/qt-6/qtcore-changes-qt6.html#qvariant>`_ with a structure dependent on the type of extension. |
+-------------+------------------------------------------------------------------------------------------------------------------------------+
...
+------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| subjectKeyIdentifier   | 2.5.29.14         | Returned as a `QVariant <https://doc.qt.io/qt-6/qtcore-changes-qt6.html#qvariant>`_ containing a QString. The string is the key identifier.                                                                                                                                                                      |
+------------------------+-------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
