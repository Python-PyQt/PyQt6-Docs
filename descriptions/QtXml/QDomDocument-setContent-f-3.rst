.. sip:method-description::
    ...
    :digest: 01801185d0c7468bcb1f11244b3d88cd
...
Text nodes consisting only of whitespace are stripped and won't appear in the :sip:ref:`~PyQt6.QtXml.QDomDocument`. If this behavior is not desired, one can use the  overload that allows a QXmlReader to be supplied.
