.. sip:method-description::
    :status: todo
    :pysig: 9f5b5cf8f2da1bb03dc1ce785acfc846
...
The standard *buttons* are added to the message box. *defaultButton* specifies the button used when Enter is pressed. *defaultButton* must refer to a button that was given in *buttons*. If *defaultButton* is :sip:ref:`~PyQt6.QtWidgets.QMessageBox.StandardButtons.NoButton`, :sip:ref:`~PyQt6.QtWidgets.QMessageBox` chooses a suitable default automatically.
