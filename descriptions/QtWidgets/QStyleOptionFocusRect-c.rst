.. sip:class-description::
    :status: todo
    :brief: Used to describe the parameters for drawing a focus rectangle with QStyle
    :digest: 9907d3a735b4e9ee303bbdb982e9b5c4

The :sip:ref:`~PyQt6.QtWidgets.QStyleOptionFocusRect` class is used to describe the parameters for drawing a focus rectangle with :sip:ref:`~PyQt6.QtWidgets.QStyle`.
