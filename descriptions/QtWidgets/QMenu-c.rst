.. sip:class-description::
    ...
    :digest: 95bb7a0d9b30a87f9bd7106f93f19011
...
Widgets can be inserted into menus with the :sip:ref:`~PyQt6.QtWidgets.QWidgetAction` class. Instances of this class are used to hold widgets, and are inserted into menus with the  overload that takes a :sip:ref:`~PyQt6.QtGui.QAction`. If the :sip:ref:`~PyQt6.QtWidgets.QWidgetAction` fires the :sip:ref:`~PyQt6.QtWidgets.QMenu.triggered` signal, the menu will close.
...
**Important inherited functions:** , removeAction(), :sip:ref:`~PyQt6.QtWidgets.QMenu.clear`, :sip:ref:`~PyQt6.QtWidgets.QMenu.addSeparator`, and :sip:ref:`~PyQt6.QtWidgets.QMenu.addMenu`.
