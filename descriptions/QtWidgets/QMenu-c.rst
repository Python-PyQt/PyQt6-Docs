...
Widgets can be inserted into menus with the :sip:ref:`~PyQt6.QtWidgets.QWidgetAction` class. Instances of this class are used to hold widgets, and are inserted into menus with the addAction() overload that takes a :sip:ref:`~PyQt6.QtGui.QAction`. If the :sip:ref:`~PyQt6.QtWidgets.QWidgetAction` fires the :sip:ref:`~PyQt6.QtWidgets.QMenu.triggered` signal, the menu will close.
