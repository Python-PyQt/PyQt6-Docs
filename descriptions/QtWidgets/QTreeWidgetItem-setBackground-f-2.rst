.. sip:method-description::
    :status: todo
    :pysig: ee69e2df0335e6a197047e88a5f69b81
...
**Note:** If `Qt Style Sheets <https://doc.qt.io/qt-6/stylesheet.html>`_ are used on the same widget as setBackground(), style sheets will take precedence if the settings conflict.
