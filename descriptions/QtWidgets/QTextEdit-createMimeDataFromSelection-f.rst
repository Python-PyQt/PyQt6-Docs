...
If you reimplement this function, note that the ownership of the returned :sip:ref:`~PyQt6.QtCore.QMimeData` object is passed to the caller. The selection can be retrieved by using the :sip:ref:`~PyQt6.QtWidgets.QTextEdit.textCursor` function.
