.. sip:method-description::
    :status: todo
    :pysig: 18df3fc7d6c04f8472dde7173eaf61f1
...
On macOS, if *parent* is not ``nullptr`` and you want your message box to appear as a :sip:ref:`~PyQt6.QtCore.Qt.WindowType.Sheet` of that parent, set the message box's :sip:ref:`~PyQt6.QtWidgets.QMessageBox.setWindowModality` to :sip:ref:`~PyQt6.QtCore.Qt.WindowModality.WindowModal` (default). Otherwise, the message box will be a standard dialog.
