.. sip:method-description::
    ...
    :realsig: (QWidget*)
    :digest: 1caeacd290efa15a48793ab555813c1a
...
Note that widgets with the :sip:ref:`~PyQt6.QtCore.Qt.WidgetAttribute.WA_PaintOnScreen` widget attribute set and widgets that wrap an external application or controller cannot be embedded. Examples are :sip:ref:`~PyQt6.QtOpenGLWidgets.QOpenGLWidget` and QAxWidget.
