.. sip:method-description::
    ...
    :realsig: (QMouseEvent*)
    :digest: 23334b8abdb7152080f77593399573aa

This event handler, for event *event*, can be reimplemented in a subclass to receive mouse press events for the widget.

If you create new widgets in the  the :sip:ref:`~PyQt6.QtWidgets.QWidget.mouseReleaseEvent` may not end up where you expect, depending on the underlying window system (or X11 window manager), the widgets' location and maybe more.
