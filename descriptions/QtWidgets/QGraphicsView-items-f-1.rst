...
This function is most commonly called from within mouse event handlers in a subclass in :sip:ref:`~PyQt6.QtWidgets.QGraphicsView`. *pos* is in untransformed viewport coordinates, just like QMouseEvent::pos().
