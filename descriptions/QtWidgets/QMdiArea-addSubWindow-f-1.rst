.. sip:method-description::
    :status: todo
    :pysig: 6b734418439ad4ee09e691c7d83c03f6
...
The *widget* can be either a :sip:ref:`~PyQt6.QtWidgets.QMdiSubWindow` or another :sip:ref:`~PyQt6.QtWidgets.QWidget` (in which case the MDI area will create a subwindow and set the *widget* as the internal widget).
