.. sip:class-description::
    ...
    :digest: 1ac1f584b400eff7497f42303c9d75f1
...
If you don't pass a parent ``window`` to the constructor, you can at a later point use :sip:ref:`~PyQt6.QtWidgets.QWidget.setLayout` to install the :sip:ref:`~PyQt6.QtWidgets.QVBoxLayout` object onto ``window``. At that point, the widgets in the layout are reparented to have ``window`` as their parent.
