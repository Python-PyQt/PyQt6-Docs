.. sip:method-description::
    ...
    :digest: ef7bc3d0ec930ef8502acfeb5ca7ee1d
...
This function is most commonly called from within mouse event handlers in a subclass in :sip:ref:`~PyQt6.QtWidgets.QGraphicsView`. *pos* is in untransformed viewport coordinates, just like QMouseEvent::position().
