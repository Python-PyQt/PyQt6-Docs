...
Note that :sip:ref:`~PyQt6.QtWidgets.QGraphicsView` currently supports background caching only (see :sip:ref:`~PyQt6.QtWidgets.QGraphicsView.CacheMode.CacheBackground`). This function is equivalent to calling update() if any layer but :sip:ref:`~PyQt6.QtWidgets.QGraphicsScene.SceneLayers.BackgroundLayer` is passed.
