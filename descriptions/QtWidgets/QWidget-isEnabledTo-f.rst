.. sip:method-description::
    ...
    :digest: 10745edc6584b70a55c1985752f6110b
...
(0) returns false if this widget or any if its ancestors was explicitly disabled.

The word ancestor here means a parent widget within the same window.

Therefore (0) stops at this widget's window, unlike :sip:ref:`~PyQt6.QtWidgets.QWidget.isEnabled` which also takes parent windows into considerations.
