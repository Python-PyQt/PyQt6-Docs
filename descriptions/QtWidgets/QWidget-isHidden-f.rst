.. sip:method-description::
    ...
    :realsig: () const
    :digest: 695fbbea1ded26c1dd7bb727c94e4060
...
isHidden() implies !\ :sip:ref:`~PyQt6.QtWidgets.QWidget.isVisible`, but a widget can be not visible and not hidden at the same time. This is the case for widgets that are children of widgets that are not visible.
