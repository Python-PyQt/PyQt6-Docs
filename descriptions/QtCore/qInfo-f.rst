.. sip:method-description::
    ...
    :realsig: (const char*)
    :digest: 58e2d9b2b72f24ba6286de524627a90e
...
To suppress the output at run-time, install your own message handler with :sip:ref:`~PyQt6.QtCore.qInstallMessageHandler`.
