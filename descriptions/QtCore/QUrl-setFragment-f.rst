.. sip:method-description::
    :status: todo
    :pysig: 0c2be1660fefb21431cf1b174e3d859d
...
:sip:ref:`~PyQt6.QtCore.QUrl.ParsingMode.DecodedMode` should be used when setting the fragment from a data source which is not a URL or with a fragment obtained by calling :sip:ref:`~PyQt6.QtCore.QUrl.fragment` with the :sip:ref:`~PyQt6.QtCore.QUrl.ComponentFormattingOption.FullyDecoded` formatting option.
