.. sip:method-description::
    :status: todo
    :pysig: 07d36332a0259d5ad8f0e713de5f3e2a
    :realsig: (const QString&, const QString&, int, QCalendar)
    :digest: ead85f2596a6970383b279e30063a64b
...
+------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| tttt       | the timezone name, either what :sip:ref:`~PyQt6.QtCore.QTimeZone.displayName` reports for :sip:ref:`~PyQt6.QtCore.QTimeZone.NameType.LongName` or the IANA ID of the zone (for example "Europe/Berlin"). The names recognized are those known to :sip:ref:`~PyQt6.QtCore.QTimeZone`, which may depend on the operating system in use. |
+------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
