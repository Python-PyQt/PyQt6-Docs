.. sip:method-description::
    ...
    :realsig: (int)
    :digest: a59f8135ed6085342b30bf2f7a50716c
...
This constructor is only available when feature ``timezone`` is enabled. The returned instance is equivalent to the lightweight time representation ``QTimeZone::fromSecondsAheadOfUtc(offsetSeconds)``, albeit implemented as a time zone.
