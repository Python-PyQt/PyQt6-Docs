.. sip:method-description::
    ...
    :digest: 54bc39805a36cd2f1345edd476803761
...
To discard all standard output from the process, pass :sip:ref:`~PyQt6.QtCore.QProcess.nullDevice` here. This is more efficient than simply never reading the standard output, as no `QProcess <https://doc.qt.io/qt-6/qtcore-changes-qt6.html#qprocess>`_ buffers are filled.
...
If the file exists and *mode* is :sip:ref:`~PyQt6.QtCore.QIODeviceBase.OpenMode.Truncate`, the file will be truncated. Otherwise (if *mode* is :sip:ref:`~PyQt6.QtCore.QIODeviceBase.OpenMode.Append`), the file will be appended to.
