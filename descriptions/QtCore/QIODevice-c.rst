.. sip:class-description::
    ...
    :digest: 5fd7a6c7c0805cca56cf5dfda8f58320
...
Before accessing the device, :sip:ref:`~PyQt6.QtCore.QIODevice.open` must be called to set the correct OpenMode (such as ReadOnly or ReadWrite). You can then write to the device with :sip:ref:`~PyQt6.QtCore.QIODevice.write` or :sip:ref:`~PyQt6.QtCore.QIODevice.putChar`, and read by calling either :sip:ref:`~PyQt6.QtCore.QIODevice.read`, :sip:ref:`~PyQt6.QtCore.QIODevice.readLine`, or :sip:ref:`~PyQt6.QtCore.QIODevice.readAll`. Call :sip:ref:`~PyQt6.QtCore.QIODevice.close` when you are done with the device.
...
Certain subclasses of :sip:ref:`~PyQt6.QtCore.QIODevice`, such as :sip:ref:`~PyQt6.QtNetwork.QTcpSocket` and :sip:ref:`~PyQt6.QtCore.QProcess`, are asynchronous. This means that I/O functions such as :sip:ref:`~PyQt6.QtCore.QIODevice.write` or :sip:ref:`~PyQt6.QtCore.QIODevice.read` always return immediately, while communication with the device itself may happen when control goes back to the event loop. :sip:ref:`~PyQt6.QtCore.QIODevice` provides functions that allow you to force these operations to be performed immediately, while blocking the calling thread and without entering the event loop. This allows :sip:ref:`~PyQt6.QtCore.QIODevice` subclasses to be used without an event loop, or in a separate thread:
...
* waitFor....() - Subclasses of :sip:ref:`~PyQt6.QtCore.QIODevice` implement blocking functions for device-specific operations. For example, :sip:ref:`~PyQt6.QtCore.QProcess` has a function called :sip:ref:`~PyQt6.QtCore.QProcess.waitForStarted` which suspends operation in the calling thread until the process has started.
