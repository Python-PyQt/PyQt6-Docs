.. sip:method-description::
    ...
    :digest: a699defa75104c61a9a0abda27bae9cb
...
To make your application perform idle processing (i.e. executing a special function whenever there are no pending events), use a QChronoTimer with 0ns timeout. More sophisticated idle processing schemes can be achieved using :sip:ref:`~PyQt6.QtCore.QEventLoop.processEvents`.
