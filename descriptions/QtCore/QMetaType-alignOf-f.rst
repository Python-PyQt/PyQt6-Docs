...
Returns the alignment of the type in bytes (i.e. alignof(T), where T is the actual type for which this `QMetaType <https://doc.qt.io/qt-6/qtcore-changes-qt6.html#qmetatype>`_ instance was constructed for).
