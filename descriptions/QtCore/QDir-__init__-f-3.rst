.. sip:method-description::
    :status: todo
    :pysig: d9dd9c586b4c98975ccb308b26e1a1f0
...
The default *nameFilter* is an empty string, which excludes nothing; the default *filters* is :sip:ref:`~PyQt6.QtCore.QDir.Filter.AllEntries`, which also excludes nothing. The default *sort* is :sip:ref:`~PyQt6.QtCore.QDir.SortFlag.Name` | :sip:ref:`~PyQt6.QtCore.QDir.SortFlag.IgnoreCase`, i.e. sort by name case-insensitively.
