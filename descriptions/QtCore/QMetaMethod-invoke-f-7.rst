...
:sip:ref:`~PyQt6.QtCore.QMetaObject.normalizedSignature` is used here to ensure that the format of the signature is what invoke() expects. E.g. extra whitespace is removed.
