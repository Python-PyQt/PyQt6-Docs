.. sip:method-description::
    ...
    :digest: db2208d5ab7bbf426e3853a8fd63dbf9
...
.. seealso:: lastModified(const QTimeZone &), lastRead(const QTimeZone &), metadataChangeTime(const QTimeZone &), fileTime(QFile::FileTime, const QTimeZone &).
