.. sip:method-description::
    ...
    :realsig: ()
    :digest: 1a65655bf4f0964231d52c1370a41aae

Decodes the current byte string and returns it. If the string is chunked, this function will iterate over all chunks and concatenate them. If an error happens, this function returns a default-constructed QByteArray(), but that may not be distinguishable from certain empty byte strings. Instead, check :sip:ref:`~PyQt6.QtCore.QCborStreamReader.lastError` to determine if an error has happened.
...
.. seealso:: :sip:ref:`~PyQt6.QtCore.QCborStreamReader.readByteArray`, readStringChunk(), :sip:ref:`~PyQt6.QtCore.QCborStreamReader.isByteArray`, :sip:ref:`~PyQt6.QtCore.QCborStreamReader.readAllString`.
