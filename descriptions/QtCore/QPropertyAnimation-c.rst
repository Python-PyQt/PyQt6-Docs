...
:sip:ref:`~PyQt6.QtCore.QPropertyAnimation` interpolates over `Qt properties <https://doc.qt.io/qt-6/properties.html>`_. As property values are stored in `QVariant <https://doc.qt.io/qt-6/qtcore-changes-qt6.html#qvariant>`_s, the class inherits :sip:ref:`~PyQt6.QtCore.QVariantAnimation`, and supports animation of the same :sip:ref:`~PyQt6.QtCore.QMetaType.Type` as its super class.
...
The property name and the :sip:ref:`~PyQt6.QtCore.QObject` instance of which property should be animated are passed to the constructor. You can then specify the start and end value of the property. The procedure is equal for properties in classes you have implemented yourself--just check with :sip:ref:`~PyQt6.QtCore.QVariantAnimation` that your `QVariant <https://doc.qt.io/qt-6/qtcore-changes-qt6.html#qvariant>`_ type is supported.
