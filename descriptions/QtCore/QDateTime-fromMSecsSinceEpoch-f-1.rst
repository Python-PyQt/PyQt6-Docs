.. sip:method-description::
    ...
    :digest: 85298af2766548766c6d410b5dfb1d4f

Returns a datetime whose date and time are the number of milliseconds *msecs* that have passed since 1970-01-01T00:00:00.000, Coordinated Universal Time (\ :sip:ref:`~PyQt6.QtCore.Qt.TimeSpec.UTC`) and converted to the given *spec*.
...
.. seealso:: :sip:ref:`~PyQt6.QtCore.QDateTime.toMSecsSinceEpoch`, :sip:ref:`~PyQt6.QtCore.QDateTime.setMSecsSinceEpoch`.
