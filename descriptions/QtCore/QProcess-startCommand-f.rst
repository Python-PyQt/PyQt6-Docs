.. sip:method-description::
    :status: todo
    :pysig: b246dbbd5a0f650afff5ad0cb031c9b0
...
On operating systems where the system API for passing command line arguments to a subprocess natively uses a single string (Windows), one can conceive command lines which cannot be passed via :sip:ref:`~PyQt6.QtCore.QProcess`'s portable list-based API. In these rare cases you need to use :sip:ref:`~PyQt6.QtCore.QProcess.setProgram` and :sip:ref:`~PyQt6.QtCore.QProcess.setNativeArguments` instead of this function.
