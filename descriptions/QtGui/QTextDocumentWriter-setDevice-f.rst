.. sip:method-description::
    ...
    :realsig: (QIODevice*)
    :digest: 338a0812140e5acb0259a513ee525159
...
**Note:** This will not work for certain devices, such as `QProcess <https://doc.qt.io/qt-6/qtcore-changes-qt6.html#qprocess>`_, QTcpSocket and QUdpSocket, where some configuration is required before the device can be opened.
