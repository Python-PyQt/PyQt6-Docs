...
When you need to invoke item functionality in a :sip:ref:`~PyQt6.QtCore.QModelIndex`-based API (e.g. QAbstractItemView), you can call this function to obtain an index that corresponds to the item's location in the model.
