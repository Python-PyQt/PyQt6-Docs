...
When a widget :sip:ref:`~PyQt6.QtWidgets.QWidget.setAcceptDrops`, it will receive this event if it has accepted the most recent :sip:ref:`~PyQt6.QtGui.QDragEnterEvent` or :sip:ref:`~PyQt6.QtGui.QDragMoveEvent` sent to it.
