.. sip:class-description::
    ...
    :digest: 533156cdb71748ba4bfb4f6c9dac603d

The :sip:ref:`~PyQt6.QtGui.QMouseEvent` class contains parameters that describe a mouse event.

Mouse events occur when a mouse button is pressed or released inside a widget, or when the mouse cursor is moved.

Mouse move events will occur only when a mouse button is pressed down, unless mouse tracking has been enabled with :sip:ref:`~PyQt6.QtWidgets.QWidget.setMouseTracking`.
...
**Note:** If a mouse event is propagated to a `widget <https://doc.qt.io/qt-6/widgets-changes-qt6.html#qwidget>`_ for which :sip:ref:`~PyQt6.QtCore.Qt.WidgetAttribute.WA_NoMousePropagation` has been set, that mouse event will not be propagated further up the parent widget chain.
...
Reimplement the `QWidget <https://doc.qt.io/qt-6/widgets-changes-qt6.html#qwidget>`_ event handlers, :sip:ref:`~PyQt6.QtWidgets.QWidget.mousePressEvent`, :sip:ref:`~PyQt6.QtWidgets.QWidget.mouseReleaseEvent`, :sip:ref:`~PyQt6.QtWidgets.QWidget.mouseDoubleClickEvent`, and :sip:ref:`~PyQt6.QtWidgets.QWidget.mouseMoveEvent` to receive mouse events in your own widgets.

.. seealso:: :sip:ref:`~PyQt6.QtWidgets.QWidget.setMouseTracking`, :sip:ref:`~PyQt6.QtWidgets.QWidget.grabMouse`, :sip:ref:`~PyQt6.QtGui.QCursor.pos`.
