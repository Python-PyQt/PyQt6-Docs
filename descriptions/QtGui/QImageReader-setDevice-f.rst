.. sip:method-description::
    ...
    :realsig: (QIODevice*)
    :digest: 4e66dcdeab39fd15411e25ccb098d9b1
...
If the device is not already open, :sip:ref:`~PyQt6.QtGui.QImageReader` will attempt to open the device in :sip:ref:`~PyQt6.QtCore.QIODeviceBase.OpenMode.ReadOnly` mode by calling open(). Note that this does not work for certain devices, such as `QProcess <https://doc.qt.io/qt-6/qtcore-changes-qt6.html#qprocess>`_, :sip:ref:`~PyQt6.QtNetwork.QTcpSocket` and :sip:ref:`~PyQt6.QtNetwork.QUdpSocket`, where more logic is required to open the device.
