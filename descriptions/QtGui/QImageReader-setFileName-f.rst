...
Sets the file name of :sip:ref:`~PyQt6.QtGui.QImageReader` to *fileName*. Internally, :sip:ref:`~PyQt6.QtGui.QImageReader` will create a :sip:ref:`~PyQt6.QtCore.QFile` object and open it in :sip:ref:`~PyQt6.QtCore.QIODeviceBase.OpenModeFlag.ReadOnly` mode, and use this when reading images.
