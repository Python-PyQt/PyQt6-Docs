.. sip:method-description::
    ...
    :digest: 0a49b199fb6590f46a651f503505f0fe
...
The  function is typically faster than :sip:ref:`~PyQt6.QtGui.QQuaternion.slerp` and will give approximate results to spherical interpolation that are good enough for some applications.
