...
It is possible to nest calls to  and :sip:ref:`~PyQt6.QtGui.QTextCursor.endEditBlock`. The top-most pair will determine the scope of the undo/redo operation.
