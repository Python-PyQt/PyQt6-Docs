.. sip:method-description::
    ...
    :realsig: (const QFont&)
    :digest: ee60c56e589dc8c501b048154f648d33

Constructs a font info object for *font*.

The font must be screen-compatible, i.e. a font you use when drawing text in widgets or :sip:ref:`~PyQt6.QtGui.QPixmap`, not :sip:ref:`~PyQt6.QtGui.QPicture` or QPrinter.
