.. sip:method-description::
    ...
    :digest: d0d7b733d7afb660777c19b55b1560f2
...
**Note:** When setting :sip:ref:`~PyQt6.QtCore.Qt.ApplicationAttribute.AA_ShareOpenGLContexts`, it is strongly recommended to place the call to this function before the construction of the :sip:ref:`~PyQt6.QtGui.QGuiApplication` or QApplication. Otherwise *format* will not be applied to the global share context and therefore issues may arise with context sharing afterwards.
