...
.. sip:class:: PyQt6.QtNetwork.QNetworkProxyQuery
    :description: QtNetwork/QNetworkProxyQuery-c.rst

    .. sip:enum:: PyQt6.QtNetwork.QNetworkProxyQuery.QueryType
        :description: QtNetwork/QNetworkProxyQuery-QueryType-e.rst

        .. sip:enum-member:: PyQt6.QtNetwork.QNetworkProxyQuery.QueryType.SctpServer
            :description: QtNetwork/QNetworkProxyQuery-QueryType-SctpServer-v.rst

        .. sip:enum-member:: PyQt6.QtNetwork.QNetworkProxyQuery.QueryType.SctpSocket
            :description: QtNetwork/QNetworkProxyQuery-QueryType-SctpSocket-v.rst

        .. sip:enum-member:: PyQt6.QtNetwork.QNetworkProxyQuery.QueryType.TcpServer
            :description: QtNetwork/QNetworkProxyQuery-QueryType-TcpServer-v.rst

        .. sip:enum-member:: PyQt6.QtNetwork.QNetworkProxyQuery.QueryType.TcpSocket
            :description: QtNetwork/QNetworkProxyQuery-QueryType-TcpSocket-v.rst

        .. sip:enum-member:: PyQt6.QtNetwork.QNetworkProxyQuery.QueryType.UdpSocket
            :description: QtNetwork/QNetworkProxyQuery-QueryType-UdpSocket-v.rst

        .. sip:enum-member:: PyQt6.QtNetwork.QNetworkProxyQuery.QueryType.UrlRequest
    ...
    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.__init__
        :args:
            ...
            type: :sip:ref:`~PyQt6.QtNetwork.QNetworkProxyQuery.QueryType` = :sip:ref:`~PyQt6.QtNetwork.QNetworkProxyQuery.QueryType.UrlRequest`
    ...
    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.localPort
        :returns:
            int
        :description: QtNetwork/QNetworkProxyQuery-localPort-f.rst

    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.__ne__
        :args:
            :sip:ref:`~PyQt6.QtNetwork.QNetworkProxyQuery`
        :returns:
            bool
    ...
    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.peerHostName
        :returns:
            str
        :description: QtNetwork/QNetworkProxyQuery-peerHostName-f.rst

    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.peerPort
        :returns:
            int
        :description: QtNetwork/QNetworkProxyQuery-peerPort-f.rst

    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.protocolTag
        :returns:
            str
        :description: QtNetwork/QNetworkProxyQuery-protocolTag-f.rst

    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.queryType
        :returns:
            :sip:ref:`~PyQt6.QtNetwork.QNetworkProxyQuery.QueryType`
        :description: QtNetwork/QNetworkProxyQuery-queryType-f.rst

    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.setLocalPort
        :args:
            int
    ...
    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.setUrl
        :args:
            :sip:ref:`~PyQt6.QtCore.QUrl`
        :description: QtNetwork/QNetworkProxyQuery-setUrl-f.rst

    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.swap
        :args:
            :sip:ref:`~PyQt6.QtNetwork.QNetworkProxyQuery`
        :description: QtNetwork/QNetworkProxyQuery-swap-f.rst

    .. sip:method:: PyQt6.QtNetwork.QNetworkProxyQuery.url
        :returns:
            :sip:ref:`~PyQt6.QtCore.QUrl`
