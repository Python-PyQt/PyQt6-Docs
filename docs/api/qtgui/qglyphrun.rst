...
.. sip:class:: PyQt6.QtGui.QGlyphRun
    ...
    .. sip:method:: PyQt6.QtGui.QGlyphRun.__init__
        ...
        :description: QtGui/QGlyphRun-__init__-f-1.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.boundingRect
        :returns:
            :sip:ref:`~PyQt6.QtCore.QRectF`
        :description: QtGui/QGlyphRun-boundingRect-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.clear
        :description: QtGui/QGlyphRun-clear-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.__eq__
        :args:
            :sip:ref:`~PyQt6.QtGui.QGlyphRun`
        :returns:
            bool
        :description: QtGui/QGlyphRun-__eq__-f.rst
    ...
    .. sip:method:: PyQt6.QtGui.QGlyphRun.isEmpty
        :returns:
            bool
        :description: QtGui/QGlyphRun-isEmpty-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.isRightToLeft
        :returns:
            bool
        :description: QtGui/QGlyphRun-isRightToLeft-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.__ne__
        :args:
            :sip:ref:`~PyQt6.QtGui.QGlyphRun`
        :returns:
            bool
        :description: QtGui/QGlyphRun-__ne__-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.overline
        :returns:
            bool
        :description: QtGui/QGlyphRun-overline-f.rst
    ...
    .. sip:method:: PyQt6.QtGui.QGlyphRun.rawFont
        ...
        :description: QtGui/QGlyphRun-rawFont-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.setBoundingRect
        :args:
            :sip:ref:`~PyQt6.QtCore.QRectF`
        :description: QtGui/QGlyphRun-setBoundingRect-f.rst
    ...
    .. sip:method:: PyQt6.QtGui.QGlyphRun.setGlyphIndexes
        :args:
            Iterable[int]
        :description: QtGui/QGlyphRun-setGlyphIndexes-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.setOverline
        :args:
            bool
        :description: QtGui/QGlyphRun-setOverline-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.setPositions
        :args:
            Iterable[:sip:ref:`~PyQt6.QtCore.QPointF`]
        :description: QtGui/QGlyphRun-setPositions-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.setRawFont
        :args:
            :sip:ref:`~PyQt6.QtGui.QRawFont`
        :description: QtGui/QGlyphRun-setRawFont-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.setRightToLeft
        :args:
            bool
    ...
    .. sip:method:: PyQt6.QtGui.QGlyphRun.swap
        :args:
            :sip:ref:`~PyQt6.QtGui.QGlyphRun`
        :description: QtGui/QGlyphRun-swap-f.rst

    .. sip:method:: PyQt6.QtGui.QGlyphRun.underline
        :returns:
            bool
        :description: QtGui/QGlyphRun-underline-f.rst
