...
.. sip:class:: PyQt6.QtGui.QPainterPath
    :description: QtGui/QPainterPath-c.rst

    .. sip:enum:: PyQt6.QtGui.QPainterPath.ElementType
        :description: QtGui/QPainterPath-ElementType-e.rst

        .. sip:enum-member:: PyQt6.QtGui.QPainterPath.ElementType.CurveToDataElement
            :description: QtGui/QPainterPath-ElementType-CurveToDataElement-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QPainterPath.ElementType.CurveToElement
            :description: QtGui/QPainterPath-ElementType-CurveToElement-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QPainterPath.ElementType.LineToElement
            :description: QtGui/QPainterPath-ElementType-LineToElement-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QPainterPath.ElementType.MoveToElement
            :description: QtGui/QPainterPath-ElementType-MoveToElement-v.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.__init__
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.__add__
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.addEllipse
        :args:
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.addPath
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :description: QtGui/QPainterPath-addPath-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.addPolygon
        :args:
            :sip:ref:`~PyQt6.QtGui.QPolygonF`
        :description: QtGui/QPainterPath-addPolygon-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.addRect
        :args:
            :sip:ref:`~PyQt6.QtCore.QRectF`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.addRegion
        :args:
            :sip:ref:`~PyQt6.QtGui.QRegion`
        :description: QtGui/QPainterPath-addRegion-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.addRoundedRect
        :args:
            :sip:ref:`~PyQt6.QtCore.QRectF`
            float
            float
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.angleAtPercent
        :args:
            float
        :returns:
            float
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.arcMoveTo
        :args:
            :sip:ref:`~PyQt6.QtCore.QRectF`
            float
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.arcTo
        :args:
            :sip:ref:`~PyQt6.QtCore.QRectF`
            float
            float
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.boundingRect
        :returns:
            :sip:ref:`~PyQt6.QtCore.QRectF`
        :description: QtGui/QPainterPath-boundingRect-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.capacity
        :returns:
            int
        :description: QtGui/QPainterPath-capacity-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.clear
        :description: QtGui/QPainterPath-clear-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.closeSubpath
        :description: QtGui/QPainterPath-closeSubpath-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.connectPath
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :description: QtGui/QPainterPath-connectPath-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.contains
        :args:
            :sip:ref:`~PyQt6.QtCore.QPointF`
        :returns:
            bool
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.controlPointRect
        :returns:
            :sip:ref:`~PyQt6.QtCore.QRectF`
        :description: QtGui/QPainterPath-controlPointRect-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.cubicTo
        :args:
            :sip:ref:`~PyQt6.QtCore.QPointF`
            :sip:ref:`~PyQt6.QtCore.QPointF`
            :sip:ref:`~PyQt6.QtCore.QPointF`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.currentPosition
        :returns:
            :sip:ref:`~PyQt6.QtCore.QPointF`
        :description: QtGui/QPainterPath-currentPosition-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.elementAt
        :args:
            int
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath.Element`
        :description: QtGui/QPainterPath-elementAt-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.elementCount
        :returns:
            int
        :description: QtGui/QPainterPath-elementCount-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.__eq__
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            bool
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.fillRule
        :returns:
            :sip:ref:`~PyQt6.QtCore.Qt.FillRule`
        :description: QtGui/QPainterPath-fillRule-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.__iadd__
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.__iand__
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.intersected
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.intersects
        :args:
            :sip:ref:`~PyQt6.QtCore.QRectF`
        :returns:
            bool
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.__ior__
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.__isub__
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.length
        :returns:
            float
        :description: QtGui/QPainterPath-length-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.lineTo
        :args:
            :sip:ref:`~PyQt6.QtCore.QPointF`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.moveTo
        :args:
            :sip:ref:`~PyQt6.QtCore.QPointF`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.__or__
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.percentAtLength
        :args:
            float
        :returns:
            float
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.pointAtPercent
        :args:
            float
        :returns:
            :sip:ref:`~PyQt6.QtCore.QPointF`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.quadTo
        :args:
            :sip:ref:`~PyQt6.QtCore.QPointF`
            :sip:ref:`~PyQt6.QtCore.QPointF`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.reserve
        :args:
            int
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.setFillRule
        :args:
            :sip:ref:`~PyQt6.QtCore.Qt.FillRule`
        :description: QtGui/QPainterPath-setFillRule-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.simplified
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :description: QtGui/QPainterPath-simplified-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.slopeAtPercent
        :args:
            float
        :returns:
            float
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.__sub__
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.subtracted
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.swap
        :args:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
        :description: QtGui/QPainterPath-swap-f.rst

    .. sip:method:: PyQt6.QtGui.QPainterPath.toFillPolygon
        :args:
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.toFillPolygons
        :args:
            matrix: :sip:ref:`~PyQt6.QtGui.QTransform` = QTransform()
        :returns:
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.toSubpathPolygons
        :args:
            matrix: :sip:ref:`~PyQt6.QtGui.QTransform` = QTransform()
        :returns:
            list[:sip:ref:`~PyQt6.QtGui.QPolygonF`]
    ...
    .. sip:method:: PyQt6.QtGui.QPainterPath.translated
        :args:
            :sip:ref:`~PyQt6.QtCore.QPointF`
        :returns:
            :sip:ref:`~PyQt6.QtGui.QPainterPath`
