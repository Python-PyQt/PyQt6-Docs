...
.. sip:class:: PyQt6.QtGui.QTextOption
    ...
    .. sip:enum:: PyQt6.QtGui.QTextOption.TabType
        ...
        .. sip:enum-member:: PyQt6.QtGui.QTextOption.TabType.CenterTab
            :description: QtGui/QTextOption-TabType-CenterTab-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QTextOption.TabType.DelimiterTab
            :description: QtGui/QTextOption-TabType-DelimiterTab-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QTextOption.TabType.LeftTab
            :description: QtGui/QTextOption-TabType-LeftTab-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QTextOption.TabType.RightTab
            :description: QtGui/QTextOption-TabType-RightTab-v.rst

    .. sip:enum:: PyQt6.QtGui.QTextOption.WrapMode
        :description: QtGui/QTextOption-WrapMode-e.rst

        .. sip:enum-member:: PyQt6.QtGui.QTextOption.WrapMode.ManualWrap
            :description: QtGui/QTextOption-WrapMode-ManualWrap-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QTextOption.WrapMode.NoWrap
            :description: QtGui/QTextOption-WrapMode-NoWrap-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QTextOption.WrapMode.WordWrap
            :description: QtGui/QTextOption-WrapMode-WordWrap-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QTextOption.WrapMode.WrapAnywhere
            :description: QtGui/QTextOption-WrapMode-WrapAnywhere-v.rst

        .. sip:enum-member:: PyQt6.QtGui.QTextOption.WrapMode.WrapAtWordBoundaryOrAnywhere
    ...
    .. sip:method:: PyQt6.QtGui.QTextOption.textDirection
        :returns:
            :sip:ref:`~PyQt6.QtCore.Qt.LayoutDirection`
        :description: QtGui/QTextOption-textDirection-f.rst

    .. sip:method:: PyQt6.QtGui.QTextOption.useDesignMetrics
        :returns:
            bool
        :description: QtGui/QTextOption-useDesignMetrics-f.rst

    .. sip:method:: PyQt6.QtGui.QTextOption.wrapMode
        :returns:
            :sip:ref:`~PyQt6.QtGui.QTextOption.WrapMode`
