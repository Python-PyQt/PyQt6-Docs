...
.. sip:class:: PyQt6.QtXml.QDomElement
    :inherits: :sip:ref:`~PyQt6.QtXml.QDomNode`
    :description: QtXml/QDomElement-c.rst

    .. sip:method:: PyQt6.QtXml.QDomElement.__init__
        :description: QtXml/QDomElement-__init__-f.rst

    .. sip:method:: PyQt6.QtXml.QDomElement.__init__
        :args:
            :sip:ref:`~PyQt6.QtXml.QDomElement`
        :description: QtXml/QDomElement-__init__-f-1.rst
    ...
    .. sip:method:: PyQt6.QtXml.QDomElement.attributes
        ...
        :description: QtXml/QDomElement-attributes-f.rst
    ...
    .. sip:method:: PyQt6.QtXml.QDomElement.nodeType
        ...
        :description: QtXml/QDomElement-nodeType-f.rst
    ...
    .. sip:method:: PyQt6.QtXml.QDomElement.removeAttributeNode
        ...
        :returns:
            :sip:ref:`~PyQt6.QtXml.QDomAttr`
        :description: QtXml/QDomElement-removeAttributeNode-f.rst
    ...
    .. sip:method:: PyQt6.QtXml.QDomElement.setAttributeNode
        ...
        :returns:
            :sip:ref:`~PyQt6.QtXml.QDomAttr`
        :description: QtXml/QDomElement-setAttributeNode-f.rst

    .. sip:method:: PyQt6.QtXml.QDomElement.setAttributeNodeNS
        :args:
            :sip:ref:`~PyQt6.QtXml.QDomAttr`
        :returns:
            :sip:ref:`~PyQt6.QtXml.QDomAttr`
        :description: QtXml/QDomElement-setAttributeNodeNS-f.rst
    ...
    .. sip:method:: PyQt6.QtXml.QDomElement.tagName
        :returns:
            str
        :description: QtXml/QDomElement-tagName-f.rst

    .. sip:method:: PyQt6.QtXml.QDomElement.text
        :returns:
            str
        :description: QtXml/QDomElement-text-f.rst
