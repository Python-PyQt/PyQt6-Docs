...
:sip:ref:`~PyQt6.QtCore.Q_ENUM` and :sip:ref:`~PyQt6.QtCore.Q_FLAG`
-------------------------------------------------------------------

The :sip:ref:`~PyQt6.QtCore.Q_ENUM` and :sip:ref:`~PyQt6.QtCore.Q_FLAG`
...
PyQt6 is to declare symbolic constants that can be used by QML, and as type of
...
the enumerated or flag type.  For example::
    ...
    from PyQt6.QtCore import Q_ENUM, Q_FLAG, QObject
...
:sip:ref:`~PyQt6.QtCore.Q_CLASSINFO`
------------------------------------

The :sip:ref:`~PyQt6.QtCore.Q_CLASSINFO` function is used in the same way as
...
For example it is used by QML to define the default property of a class::
    ...
    from PyQt6.QtCore import Q_CLASSINFO, QObject
