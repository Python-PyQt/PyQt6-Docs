...
Support for :sip:ref:`~PyQt5.QtCore.QVariant`
=============================================

PyQt4 implements two APIs for :sip:ref:`~PyQt5.QtCore.QVariant`.  v1 (the
default for Python v2) exposes the :sip:ref:`~PyQt5.QtCore.QVariant` class to
Python and requires applications to explicitly convert a
:sip:ref:`~PyQt5.QtCore.QVariant` to the actual value.  v2 (the default for
Python v3) does not expose the :sip:ref:`~PyQt5.QtCore.QVariant` class to
Python and automatically converts a :sip:ref:`~PyQt5.QtCore.QVariant` to the
actual value.  While this is usually the best thing to do, it does raise
problems of its own:

- Information is lost when converting between a C++
  :sip:ref:`~PyQt5.QtCore.QVariant` and the corresponding Python object.  For
  example a :sip:ref:`~PyQt5.QtCore.QVariant` distinguishes between signed
...
- There is no obvious way to represent a null
  :sip:ref:`~PyQt5.QtCore.QVariant` as a standard Python object.  PyQt4
...
In PyQt5 the implementation of :sip:ref:`~PyQt5.QtCore.QVariant` is different
...
C++ :sip:ref:`~PyQt5.QtCore.QVariant` to a Python object and to return a
wrapped Python :sip:ref:`~PyQt5.QtCore.QVariant` instead - behaviour similar
to PyQt4's v1 API - by calling the :func:`sip.enableautoconversion` function.

The actual value of a wrapped Python :sip:ref:`~PyQt5.QtCore.QVariant` is
...
An invalid :sip:ref:`~PyQt5.QtCore.QVariant` is automatically converted to
``None`` and vice versa.
