...
The :sip:ref:`~PyQt5.QtCore` module contains the
:sip:ref:`~PyQt5.QtCore.pyqtRemoveInputHook` and
:sip:ref:`~PyQt5.QtCore.pyqtRestoreInputHook` functions that remove and restore
